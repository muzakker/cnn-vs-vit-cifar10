#!/bin/bash
#SBATCH --job-name=dinov2_cifar10
#SBATCH --output=dinov2_cifar10_%j.out
#SBATCH --error=dinov2_cifar10_%j.err
...
# Clean environment or create new
...
conda install -y matplotlib=3.7.2 tqdm=4.65.0

# Create the DINOv2-Small implementation file using PyTorch Hub
cat > train_dinov2.py << 'EOF'
"""
